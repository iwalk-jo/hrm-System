                        ...
                        <?php if (!empty($emp_perform)) { ?>
                            ...
                            <?php foreach ($emp_perform as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                        ...
                                        <td><?php echo $que->number_of_star; ?></td>
                ...
                <div class="panel-body">
                    ...
                    <?= form_open_multipart('employee/Employees/create_emp_performance') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <select name="employee_id" id="employee_id" class="form-control" onchange="SelectToLoad(this.value),SelectToname(this.value)"   style="width:390px">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="number_of_star" class="form-control" type="text" placeholder="<?php echo display('number_of_star') ?>" id="number_of_star">
                            </div>
                            </div>
                            <div class="form-group row">
